...
| Use | Source | Why |
|---|---|---|
| **Built-in library** | **USDA SR Legacy + FNDDS, bundled (`js/commonfoods.js`)** | **5,552 everyday foods that need no network, key or proxy. Every one has a lab-measured P *and* K.** |
...
So 5,552 everyday foods ship with the app. They appear **as you type**, with no
...
- Type-ahead renders **25 matches** and reports the true total. At 5,552 foods a
...
eyeball 5,552 bindings. So the generator warns on three patterns, each modelled
...
js/commonfoods.js       GENERATED: 5,552 offline foods, SR Legacy + FNDDS (605 KB, 158 KB gzipped)

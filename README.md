...
| Use | Source | Why |
|---|---|---|
| **Built-in library** | **USDA SR Legacy + FNDDS, bundled (`js/commonfoods.js`)** | **3,031 everyday foods that need no network, key or proxy. Every one has a lab-measured P *and* K.** |
...
So 3,031 everyday foods ship with the app. They appear **as you type**, with no
...
- Type-ahead renders **25 matches** and reports the true total. At 3,031 foods a
...
eyeball 3,031 bindings. So the generator warns on three patterns, each modelled
...
js/commonfoods.js       GENERATED: 3,031 offline foods, SR Legacy + FNDDS (305 KB, 91 KB gzipped)

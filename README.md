...
| Use | Source | Why |
|---|---|---|
| **Built-in library** | **USDA SR Legacy + FNDDS, bundled (`js/commonfoods.js`)** | **2,128 everyday foods that need no network, key or proxy. Every one has a lab-measured P *and* K.** |
...
So 2,128 everyday foods ship with the app. They appear **as you type**, with no
...
|---|---|---|---|
| **SR Legacy** | 1,078 | Laboratory-analysed whole foods | Bananas, chicken breast, cheddar — the ingredients |
...
- Type-ahead renders **25 matches** and reports the true total. At 2,128 foods a
...
eyeball 2,128 bindings. So the generator warns on three patterns, each modelled
...
js/commonfoods.js       GENERATED: 2,128 offline foods, SR Legacy + FNDDS (214 KB, 68 KB gzipped)

...
| Use | Source | Why |
|---|---|---|
| **Built-in library** | **USDA SR Legacy + FNDDS, bundled (`js/commonfoods.js`)** | **2,499 everyday foods that need no network, key or proxy. Every one has a lab-measured P *and* K.** |
...
So 2,499 everyday foods ship with the app. They appear **as you type**, with no
...
- Type-ahead renders **25 matches** and reports the true total. At 2,499 foods a
...
eyeball 2,499 bindings. So the generator warns on three patterns, each modelled
...
js/commonfoods.js       GENERATED: 2,499 offline foods, SR Legacy + FNDDS (251 KB, 78 KB gzipped)

...
| Use | Source | Why |
|---|---|---|
| **Built-in library** | **USDA SR Legacy + FNDDS, bundled (`js/commonfoods.js`)** | **5,841 everyday foods that need no network, key or proxy. Every one has a lab-measured P *and* K.** |
...
So 5,841 everyday foods ship with the app. They appear **as you type**, with no
...
- Type-ahead renders **25 matches** and reports the true total. At 5,841 foods a
...
eyeball 5,841 bindings. So the generator warns on three patterns, each modelled
...
js/commonfoods.js       GENERATED: 5,841 offline foods, SR Legacy + FNDDS (500 KB, 142 KB gzipped; descriptions split into commonfoods-desc.js)
